...
----------------------------------------*/
class real_estate_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('real_estate_instagram_photo',esc_html__('[ Real_Estate ] Intagram Photo','real_estate-companion'),array(
			'description' => esc_html__('Real_Estate Instagram Photo Widget','real_estate-companion'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'real_estate-companion');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'real_estate-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'real_estate-companion'); ?></label>
...
if(!function_exists('real_estate_instagram_widgets')):
	function real_estate_instagram_widgets(){
		register_widget('real_estate_instagram_photo');
	}
	add_action('widgets_init','real_estate_instagram_widgets');
endif;
