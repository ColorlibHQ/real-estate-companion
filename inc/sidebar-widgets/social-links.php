...
class Real_Estate_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        'real_estate_social_links',


        // Widget name will appear in UI
        esc_html__( '[ Real_Estate ] Social Links', 'real_estate-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'real_estate-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'real_estate-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'real_estate-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'real_estate-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'real_estate-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'real_estate-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'real_estate-companion'); ?></label>
...
} // Class real_estate_social_links ends here


// Register and load the widget
function real_estate_social_links_widget_load() {
	register_widget( 'Real_Estate_social_links' );
}
add_action( 'widgets_init', 'real_estate_social_links_widget_load' );