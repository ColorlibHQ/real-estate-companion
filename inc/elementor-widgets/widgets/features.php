...
/**
 *
 * Real_Estate elementor features section widget.
 *
 * @since 1.0
 */
class Real_Estate_Features extends Widget_Base {

	public function get_name() {
		return 'real_estate-features';
	}

	public function get_title() {
		return __( 'App Features', 'real_estate-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'features_content',
			[
				'label' => __( 'Features content', 'real_estate-companion' ),
			]
        );
        $this->add_control(
            'left_img',
            [
                'label' => esc_html__( 'Left Image', 'real_estate-companion' ),
                'description' => esc_html__( 'Best size is 372x655', 'real_estate-companion' ),
        ...
        $this->add_control(
            'right_img',
            [
                'label' => esc_html__( 'Right Image', 'real_estate-companion' ),
                'description' => esc_html__( 'Best size is 561x707', 'real_estate-companion' ),
                'type' => Controls_Manager::MEDIA,
                'label_block' => true,
                'default'     => [
                    'url'   => Utils::get_placeholder_image_src(),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Features', 'real_estate-companion' ),
            ...
            'features', [
                ...
                'fields' => [
                    [
                        ...
                        'default'     => __( 'Sign Up for free', 'real_estate-companion' ),
                    ],
                    [
                        'name' => 'item_text',
                        'label' => __( 'Short Text', 'real_estate-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXTAREA,
                        'default'     => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod tempor.', 'real_estate-companion' ),
                    ],
                ],
                'default'   => [
                    [      
                        'item_title'    => __( 'Sign Up for free', 'real_estate-companion' ),
                        'item_text'   => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod tempor.', 'real_estate-companion' ),
                    ],
                    [      
                        'item_title'    => __( 'Make your profile', 'real_estate-companion' ),
                        'item_text'   => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod tempor.', 'real_estate-companion' ),
                    ],
                    [      
                        'item_title'    => __( 'Enjoy the app', 'real_estate-companion' ),
                        'item_text'   => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod tempor.', 'real_estate-companion' ),
                    ],
                ]
            ]
    ...
    $left_img  = !empty( $settings['left_img']['id'] ) ? wp_get_attachment_image( $settings['left_img']['id'], 'real_estate_service_man_thumb_372x655', '', array( 'alt' => 'left image' ) ) : '';
    $right_img = !empty( $settings['right_img']['id'] ) ? wp_get_attachment_image( $settings['right_img']['id'], 'real_estate_service_right_thumb_561x707', '', array( 'alt' => 'right image' ) ) : '';
