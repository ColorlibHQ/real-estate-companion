...
/**
 *
 * Real_Estate elementor business expert section widget.
 *
 * @since 1.0
 */
class Real_Estate_Business_Expert extends Widget_Base {

	public function get_name() {
		return 'real_estate-business-expert';
	}

	public function get_title() {
		return __( 'Business Expert', 'real_estate-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Business Expert content', 'real_estate-companion' ),
			]
        );
		$this->add_control(
            'tab_content', [
                ...
                'fields' => [
                    [
                        'name' => 'tab_title',
                        'label' => __( 'Tab Title', 'real_estate-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Excellent Services', 'real_estate-companion' ),
                    ],
                    [
                        'name' => 'template_id',
                        'label' => __( 'Select Elementor Template', 'real_estate-companion' ),
                        'label_block' => true,
                ...
                'default'   => [
                    [      
                        'tab_title' => __( 'Excellent Services', 'real_estate-companion' ),
                    ],
                    [      
                        'tab_title' => __( 'Qualified Doctors', 'real_estate-companion' ),
                    ],
                    [      
                        'tab_title' => __( 'Emergency Departments', 'real_estate-companion' ),
                    ],
                ]
            ]
		);
    ...
    $this->start_controls_section(
        'style_room_section', [
            'label' => __( 'Style Business Expert Section', 'real_estate-companion' ),
            'tab' => Controls_Manager::TAB_STYLE,
        ]
    );
    $this->add_control(
        'section_head_bg_col', [
            'label' => __( 'Section Head Bg Color', 'real_estate-companion' ),
    ...
    $this->add_control(
        'tab_content_styles_separator', [
            'label' => __( 'Tab Content Styles', 'real_estate-companion' ),
    ...
    $this->add_control(
        'icon_bg_col', [
            'label' => __( 'Icon Bg Color', 'real_estate-companion' ),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
