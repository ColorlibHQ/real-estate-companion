...
/**
 *
 * Real_Estate elementor program details section widget.
 *
 * @since 1.0
 */
class Real_Estate_Program_Details extends Widget_Base {

	public function get_name() {
		return 'real_estate-program-details';
	}

	public function get_title() {
		return __( 'Program Details', 'real_estate-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Program Details Settings', 'real_estate-companion' ),
            ]
        );
        $this->add_control(
            'sec_title',
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Program. Details', 'real_estate-companion' ),
            ]
        );
		...
		$this->add_control(
            'events', [
                ...
                'fields' => [
                    [
                        'name' => 'time',
                        'label' => __( 'Time', 'real_estate-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( '16.00', 'real_estate-companion' ),
                    ],
                    [
                        'name' => 'title',
                        ...
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Wedding Ceremony', 'real_estate-companion' ),
                    ],
                    [
                        'name' => 'text',
                        ...
                        'default' => __( 'Many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some content of a page when looking at its layout.', 'real_estate-companion' ),
                    ],
                    [
                        'name' => 'bg_img',
                        'label' => __( 'BG Image', 'real_estate-companion' ),
                        'label_block' => true,
                ...
                'default'   => [
                    [
                        'time'            => __( '16.00', 'real_estate-companion' ),
                        'title'           => __( 'Wedding Ceremony', 'real_estate-companion' ),
                        'text'            => __( 'Many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some content of a page when looking at its layout.', 'real_estate-companion' ),
                        'bg_img'          => [
                            'url'         => Utils::get_placeholder_image_src(),
                        ],
                    ],
                    [
                        'time'            => __( '20.00', 'real_estate-companion' ),
                        'title'           => __( 'Lunch Time', 'real_estate-companion' ),
                        'text'            => __( 'Many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some content of a page when looking at its layout.', 'real_estate-companion' ),
                        'bg_img'          => [
                            'url'         => Utils::get_placeholder_image_src(),
                        ],
                    ...
                    [
                        'time'            => __( '22.00', 'real_estate-companion' ),
                        'title'           => __( 'Party Time', 'real_estate-companion' ),
                        'text'            => __( 'Many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some content of a page when looking at its layout.', 'real_estate-companion' ),
                        'bg_img'          => [
                            'url'         => Utils::get_placeholder_image_src(),
                        ],
    ...
    $ornaments_img   = REAL_ESTATE_DIR_IMGS_URI . 'ornaments.png';
    ?>
                ...
                if( is_array( $events ) && count( $events ) > 0 ){
                    foreach ( $events as $event ) {
                        ...
                        <div class="col-xl-4 col-lg-4">
                            <div class="single_program text-center" <?php echo real_estate_inline_bg_img( esc_url( $bg_img ) ); ?>>
