...
/**
 *
 * Real_Estate elementor app section widget.
 *
 * @since 1.0
 */
class Real_Estate_App_Section extends Widget_Base {

	public function get_name() {
		return 'real_estate-app-section';
	}

	public function get_title() {
		return __( 'App Section', 'real_estate-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'apps_content',
            [
                'label' => __( 'App Section Settings', 'real_estate-companion' ),
            ]
        );
        $this->add_control(
            'sec_img',
            [
                ...
                'description' => esc_html__( 'Best size is 1920x456', 'real_estate-companion' ),
        ...
        $this->add_control(
            'ios_url',
            [
                'label' => esc_html__( 'IOS App URL', 'real_estate-companion' ),
        ...
        $this->add_control(
            'android_url',
            [
                'label' => esc_html__( 'Android App URL', 'real_estate-companion' ),
                'type' => Controls_Manager::URL,
                'label_block' => true,
                'default'   => [
                    'url' => '#'
    ...
    public function real_estate_left_contents( $sec_title, $sec_text, $btn_label, $btn_url, $style_type ) {
    ...
    public function real_estate_right_contents( $sec_img, $style_type ) {
    ...
    $ios_app_path = REAL_ESTATE_DIR_ICON_IMG_URI . 'ios-app.svg';
    $android_app_path = REAL_ESTATE_DIR_ICON_IMG_URI . 'android-app.svg';
    ?>
    
    <!-- productivity_area  -->
    <div class="productivity_area" <?php echo real_estate_inline_bg_img( esc_url( $sec_img ) ); ?>>
        <div class="container">
