...
/**
 *
 * Real_Estate elementor home appointment section widget.
 *
 * @since 1.0
 */
class Real_Estate_Home_Appointment extends Widget_Base {

	public function get_name() {
		return 'real_estate-home-appointment-section';
	}

	public function get_title() {
		return __( 'Home Appointment', 'real_estate-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Home Appointment Section', 'real_estate-companion' ),
            ]
        );
        $this->add_control(
            'top_img',
            [
                'label' => esc_html__( 'Top Image', 'real_estate-companion' ),
        ...
        $this->add_control(
            'bottom_img',
            [
                'label' => esc_html__( 'Bottom Image', 'real_estate-companion' ),
                'type' => Controls_Manager::MEDIA,
                'label_block' => true,
                'default'     => [
                    'url'   => Utils::get_placeholder_image_src(),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Form Contents Section', 'real_estate-companion' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Are You Attending?', 'real_estate-companion' ),
            ]
        );
        $this->add_control(
            'sub_title',
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Kindly respond before 30 August', 'real_estate-companion' ),
            ]
        );
        ...
        $this->start_controls_section(
            'home_contact_sec_style', [
                'label' => __( 'Home Contact Section Styles', 'real_estate-companion' ),
        ...
        $this->add_control(
			'btn_border_txt_col', [
				'label' => __( 'Button Border & Text Color', 'real_estate-companion' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
        ...
        $this->add_control(
			'btn_hvr_border_bg_col', [
				'label' => __( 'Button Hover Border & Bg Color', 'real_estate-companion' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
        ...
        $this->add_control(
			'btn_hvr_txt_col', [
				'label' => __( 'Button Hover Text Color', 'real_estate-companion' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
    ...
    $top_img       = !empty( $settings['top_img']['id'] ) ? wp_get_attachment_image( $settings['top_img']['id'], 'real_estate_wedding_counter_left_img_471x280', '', array('alt' => 'home appointment top image' ) ) : '';
    $bottom_img       = !empty( $settings['bottom_img']['id'] ) ? wp_get_attachment_image( $settings['bottom_img']['id'], 'real_estate_attending_bottom_thumb_350x346', '', array('alt' => 'home appointment bottom image' ) ) : '';
