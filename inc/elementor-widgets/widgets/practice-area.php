...
/**
 *
 * Real_Estate elementor parctice area widget.
 *
 * @since 1.0
 */
class Real_Estate_Practice_Area extends Widget_Base {

	public function get_name() {
		return 'real_estate-practice-area';
	}

	public function get_title() {
		return __( 'Practice Area', 'real_estate-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Practice Area content', 'real_estate-companion' ),
			]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Practice Area', 'real_estate-companion' ),
            ]
        );
        $this->add_control(
            'sub_title',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Practice Items', 'real_estate-companion' ),
		...
		$this->add_control(
            'practice_items', [
                ...
                'fields' => [
                    [
                        'name' => 'item_bg_img',
                        'label' => __( 'Item BG Image', 'real_estate-companion' ),
                        'label_block' => true,
                    ...
                    [
                        'name' => 'item_icon',
                        'label' => __( 'Item Icon', 'real_estate-companion' ),
                        'label_block' => true,
                    ...
                    [
                        'name' => 'item_title',
                        'label' => __( 'Item Title', 'real_estate-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Business Law', 'real_estate-companion' ),
                    ],
                    [
                        'name' => 'item_text',
                        'label' => __( 'Item Text', 'real_estate-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXTAREA,
                    ...
                    [
                        'name' => 'btn_text',
                        'label' => __( 'Anchor Text', 'real_estate-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                    ...
                    [
                        'name' => 'btn_url',
                        'label' => __( 'Anchor URL', 'real_estate-companion' ),
                        'label_block' => true,
                ...
                'default'   => [
                    [     
                        ...
                        'item_title' => __( 'Business Law', 'real_estate-companion' ),
                    ...
                    [     
                        ...
                        'item_title' => __( 'Finance Law', 'real_estate-companion' ),
                        'item_text'  => 'There are many variations of passages of <br> Lorem Ipsum available, <br> but the majority have suffered',
                        'btn_text'     => __( 'Learn More', 'real_estate-companion' ),
                        'btn_url'     => [
                            'url'      => '#'
                    ...
                    [     
                        ...
                        'item_title' => __( 'Family Law', 'real_estate-companion' ),
                        'item_text'  => 'There are many variations of passages of <br> Lorem Ipsum available, <br> but the majority have suffered',
                        'btn_text'     => __( 'Learn More', 'real_estate-companion' ),
                        'btn_url'     => [
                            'url'      => '#'
                    ...
                    [     
                        ...
                        'item_title' => __( 'Education Law', 'real_estate-companion' ),
                        'item_text'  => 'There are many variations of passages of <br> Lorem Ipsum available, <br> but the majority have suffered',
                        'btn_text'     => __( 'Learn More', 'real_estate-companion' ),
                        'btn_url'     => [
                            'url'      => '#'
     ...
     */
        ...
        $this->add_control(
            'sec_bg_col', [
                'label' => __( 'Section Bg Color', 'real_estate-companion' ),
        ...
        $this->add_control(
            'sec_mid_bg_col', [
                'label' => __( 'Middle Section Bg Color', 'real_estate-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Single Service Item Styles', 'real_estate-companion' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'after'
            ]
        );
        $this->add_control(
            'item_icon_col', [
                'label' => __( 'Icon Color', 'real_estate-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Button Hover Styles', 'real_estate-companion' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'after'
            ]
        );
            ...
            <div class="row no-gutters">
                ...
                if( is_array( $practice_items ) && count( $practice_items ) > 0 ) {
                    foreach( $practice_items as $item ) {
                        ...
                        $item_bg_img  = !empty( $item['item_bg_img']['id'] ) ? wp_get_attachment_image( $item['item_bg_img']['id'], 'real_estate_practice_thumb_448x500', '', array('alt' => $item_title . ' image' ) ) : '';
