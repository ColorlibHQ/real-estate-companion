...
/**
 *
 * Real_Estate elementor contact info section section widget.
 *
 * @since 1.0
 */
class Real_Estate_Contact_Info_Section extends Widget_Base {

	public function get_name() {
		return 'real_estate-emergency-contact-section';
	}

	public function get_title() {
		return __( 'Emergency Contact Section', 'real_estate-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Emergency Contact Section', 'real_estate-companion' ),
            ]
        );
        $this->add_control(
            'ec_bg_img',
        ...
        $this->add_control(
            'ec_title',
            [
                'label' => esc_html__( 'Sec Title', 'real_estate-companion' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => esc_html__( 'For Any Information Call Us', 'real_estate-companion' ),
            ]
        );
        $this->add_control(
            'ec_text',
        ...
        $this->add_control(
            'ec_btn_label',
            [
                'label' => esc_html__( 'Phone', 'real_estate-companion' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => esc_html__( '+10 673 763 6786', 'real_estate-companion' ),
            ]
        );
        ...
        $this->start_controls_section(
            'left_sec_style', [
                'label' => __( 'Top Section Styles', 'real_estate-companion' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Overlay Color Styles', 'real_estate-companion' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'after'
            ]
        );
        $this->add_control(
			'sec_title_col', [
				'label' => __( 'Bg Overlay Color', 'real_estate-companion' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
    ...
    <!-- Information_area  -->
    <div class="Information_area overlay" <?php echo real_estate_inline_bg_img( esc_url( $ec_bg_img ) ); ?>>
        <div class="container">
