...
/**
 *
 * Real_Estate elementor departments section widget.
 *
 * @since 1.0
 */
class Real_Estate_Departments extends Widget_Base {

	public function get_name() {
		return 'real_estate-departments';
	}

	public function get_title() {
		return __( 'Departments', 'real_estate-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'departments_content',
			[
				'label' => __( 'Departments Section', 'real_estate-companion' ),
			]
        );
        $this->add_control(
            'sec_title',
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Our Departments', 'real_estate-companion' ),
            ]
        );
        $this->add_control(
            'sub_title',
		...
		$this->add_control(
            'departments', [
                ...
                'fields' => [
                    [
                        'name' => 'item_img',
                        'label' => __( 'Department Image', 'real_estate-companion' ),
                        'label_block' => true,
                    ...
                    [
                        'name' => 'item_title',
                        'label' => __( 'Department Title', 'real_estate-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Eye Care', 'real_estate-companion' ),
                    ],
                    [
                        'name' => 'item_text',
                        'label' => __( 'Department Text', 'real_estate-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXTAREA,
                ...
                'default'   => [
                    [      
                        ...
                        'item_title' => __( 'Eye Care', 'real_estate-companion' ),
                    ...
                    [      
                        ...
                        'item_title' => __( 'Physical Therapy', 'real_estate-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'real_estate-companion' ),
                        'btn_text'   => __( 'Learn More', 'real_estate-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Dental Care', 'real_estate-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'real_estate-companion' ),
                        'btn_text'   => __( 'Learn More', 'real_estate-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Diagnostic Test', 'real_estate-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'real_estate-companion' ),
                        'btn_text'   => __( 'Learn More', 'real_estate-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Skin Surgery', 'real_estate-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'real_estate-companion' ),
                        'btn_text'   => __( 'Learn More', 'real_estate-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Surgery Service', 'real_estate-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'real_estate-companion' ),
                        'btn_text'   => __( 'Learn More', 'real_estate-companion' ),
                        'btn_url'    => [
                            'url' => '#'
     ...
     */
        ...
        $this->add_control(
            'title_hover_col', [
                'label' => __( 'Title Hover Color', 'real_estate-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'anchor_text_col', [
                'label' => __( 'Anchor Text Color', 'real_estate-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
            ...
            <div class="row">
                ...
                if( is_array( $departments ) && count( $departments ) > 0 ) {
                    foreach( $departments as $department ) {
                        ...
                        $item_img = !empty( $department['item_img']['id'] ) ? wp_get_attachment_image( $department['item_img']['id'], 'real_estate_department_thumb_362x240', '', array('alt' => $item_title . ' image' ) ) : '';
